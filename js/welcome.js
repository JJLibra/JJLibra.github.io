...
function showWelcome() {
    ...
    let timeChange;
    let date = new Date();
    if (date.getHours() >= 5 && date.getHours() < 11) timeChange = " 早上好，一日之计在于晨";
    else if (date.getHours() >= 11 && date.getHours() < 13) timeChange = " 中午好，记得午休喔~";
    else if (date.getHours() >= 13 && date.getHours() < 17) timeChange = " 下午好，饮茶先啦！";
    else if (date.getHours() >= 17 && date.getHours() < 19) timeChange = " 即将下班，记得按时吃饭~";
